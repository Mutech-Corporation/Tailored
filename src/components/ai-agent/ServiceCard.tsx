...
export function ServiceCard({ variant, icon: Icon, phoneLabel, title, messages, description }: ServiceCardData) {
  return (
    <div className="flex h-full flex-col gap-3 rounded-2xl border border-[#dfe3e8] bg-white p-5 px-[1.25rem] shadow-[0_4px_12px_rgba(0,0,0,0.04)] transition-all duration-300 hover:-translate-y-2 hover:border-[#2563eb] hover:shadow-[0_12px_30px_rgba(255,42,64,0.15)]">
      <div
