...
Both the brand source images and the superseded logo set live outside this
repository, alongside it:

    ../docs and logos/          brand sheets and briefs (input to the scripts)
    ../backup-brand-logos-v1/   the previous logo PNGs

Nothing in either folder is published with the site.
